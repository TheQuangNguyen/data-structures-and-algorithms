...
const detectTicTacToeWin = (board) => {
  for(let i = 0; i < 3; i++) { 
    if(checkWin(i,0,i,1,i,2,board)) {return true};
    if(checkWin(0,i,1,i,2,i,board)) {return true};
  }
  if(checkWin(0,0,1,1,2,2,board)) {return true};
  if(checkWin(2,2,1,1,0,0,board)) {return true};
  return false;
};

function checkWin(row1, col1, row2, col2, row3, col3,board) { 
