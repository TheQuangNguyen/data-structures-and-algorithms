...
public class LeftJoin {
    ...
    public static String[][] leftJoin(HashMap<String, String> synonym, HashMap<String, String> antonym) {
        ...
        // Iterate through every entries of synonym if the same key exists in antonym
        // If yes, include both values in result
        // If not, include value for synonym along with null
